...
| Verkada | Backend Engineer - Connectivity | submitted | Strongest substantive match among three dated openings: Python backend engineering, scalable distributed systems, Redis, PostgreSQL, Kubernetes, REST APIs, low-latency/high-throughput services, and production ownership; posting explicitly offers visa sponsorship. Associate Solutions role was excluded for no sponsorship, and the frontend role was a slightly weaker fit to the candidate's backend-heavy record. PR #298. Submission completed by the candidate. |
| NVIDIA | Software Quality Assurance Engineer - 2026 New College Grad | submitted | Strongest NVIDIA match for the candidate's QA automation, Python scripting, debugging, root cause analysis, defect validation, CI/CD regression testing, Linux/cloud systems, and AI-driven tooling. Listing indicates likely H-1B sponsorship. PR #296. Submission completed by the candidate. |
...
| Snap Inc. | Software Engineer, iOS, Level 3 | skipped | Only dated Snap opening requires a proven record shipping consumer iOS features plus iOS networking, concurrency, and performance tuning; candidate's demonstrated experience is backend, web, cloud, and AI rather than native iOS. |
| Lyft | Software Engineer | package merged; application pending | Strong match for Python, services/APIs, production systems at scale, proof-of-concept prototyping, reliability/performance evaluation, data structures, algorithms, system design, testing, and distributed systems; likely H-1B sponsorship. PR #300. |
| Google | Software Engineer, Early Career, Campus | package merged; application pending | Strongest Google match for the candidate's bachelor's/master's degrees, data structures, algorithms, Python/Java/JavaScript, AI productivity tools, web applications, Unix/Linux, distributed systems, machine learning, NLP, information retrieval, and large software systems; likely H-1B sponsorship. PhD-specific alternatives were excluded. PR #301. |
