...
== Technical Skills
#sk("Languages",    "JavaScript/TypeScript, Java, Rust, Python")
#sk("Frameworks",   "React, FastAPI, FastMCP, LangGraph, LangChain, LangSmith, PyTorch, Spring Boot")
...
- Built *generative code solutions* for developers (API-aware templates, SDK patterns, and code-generation workflows) using *TypeScript* and *React* to accelerate integration with platform *APIs* and improve the correctness of implementations
...
- Conducted workshops on GPU programming with *CUDA*, *Mojo* and building *AI Agents* with *LangChain*, *LangGraph*, and *LangSmith* for *+50* students, mentoring peers on advanced technical topics

#work("Software Engineer", "Noida, India", "Qualitest", "Feb 2021 - Dec 2023")
- Contributed to the development of an Identity & Access Management platform using *React.js*, *TypeScript*, *Spring Boot*, and *AWS*, building *user interfaces* that supported thousands of users across 30+ applications
