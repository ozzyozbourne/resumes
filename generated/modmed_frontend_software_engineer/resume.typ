...
- Built *generative code solutions* for developers (API-aware templates, SDK patterns, and *code-generation workflows*) to accelerate integration with platform *REST APIs* and improve the correctness of implementations
...
- Contributed to the development of an Identity & Access Management platform using *React*, *Spring Boot*, and *AWS*, supporting thousands of users across *30+ applications* with *user-facing features* and *reusable component* architecture
- Designed and developed a cloud-agnostic Storage Service using *Python*, *PostgreSQL*, and *Redis* that seamlessly handles file uploads, downloads, and deletions in *Google Cloud Storage*, *S3*, and *MinIO* via expiring *signed URLs*
